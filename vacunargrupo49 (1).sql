...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2023 a las 01:08:21
...
(4, 1, 2, '2023-10-15 00:00:00', 'Centro de vacunacion ATE', '2023-11-09 00:00:00', 2, 0),
...
(46, 2, 1, '2023-10-25 00:00:00', 'Centro de Vacunacion 2.', '2023-11-24 00:00:00', 2, 1);
...
(1, 123, 'Juan Lopez', 'juan@lopez', '012', 'hiv', 'Salud', 0),
(2, 23456789, 'Maria DeBernardi', 'MariaDB234@gmail.com', '15-3456-7890', 'Afeccion pulmonar', 'Bomberos', 0),
...
--
ALTER TABLE `citavacunacion`
  MODIFY `idCodCita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
